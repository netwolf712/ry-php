  ...
  <div class="register">
    <el-form ref="registerForm" :model="registerForm" :rules="registerRules" class="register-form">
      ...
      <el-form-item prop="username">
        <el-input v-model="user.userName" type="text" auto-complete="off" placeholder="账号" disabled>
      ...
      <el-form-item style="width:100%;">
        ...
        <div style="float: right;">
          <router-link class="link-type" :to="'/'">跳过</router-link>
        </div>
      </el-form-item>
    </el-form>
    <!--  底部  -->
      ...
      this.$refs.registerForm.validate(valid => {
        if (valid) {
          ...
          resetSelfPwd(this.registerForm.password).then(res => {
            this.$alert("<font color='red'>恭喜你，您的密码修改成功！</font>", '系统提示', {
