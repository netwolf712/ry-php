...
CREATE TABLE `sys_menu` (
  ...
  `status` char(1) DEFAULT '0' COMMENT '状态（0正常，1停用）',
  PRIMARY KEY (`menu_id`)
) ENGINE=MyISAM AUTO_INCREMENT=1113 DEFAULT CHARSET=utf8 COMMENT='菜单权限表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `sys_post` (
  ...
  `remark` varchar(500) DEFAULT NULL COMMENT '备注',
  PRIMARY KEY (`post_id`)
) ENGINE=MyISAM AUTO_INCREMENT=8 DEFAULT CHARSET=utf8 COMMENT='岗位信息表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2023-09-26 17:47:35
