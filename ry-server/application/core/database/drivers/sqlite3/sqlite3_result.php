...
class CI_DB_sqlite3_result extends CI_DB_result {
	...
	function num_rows()
	{
		...
		while ($this->result_id->fetchArray())
			$nrows++;
		$this->result_id->reset();
		return $nrows;
	}
	...
	function num_fields()
	{
		...
		if ($this->reult_id->numColumns() && $this->reult_id->columnType(0) != SQLITE3_NULL) {

			// have rows
			return $this->reult_id->numColumns();
	...
	function _fetch_assoc()
	{
		...
		return $this->result_id->fetchArray();
	}
