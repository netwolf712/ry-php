...
class Helper
{
    ...
    static public function load_model($modelName,$db)
    {
        require APP . 'model/'.lcfirst($modelName).'_model.php';
        // create new "model" (and pass the database connection)
        $modelClassName = ucwords($modelName)."_Model";
        return new $modelClassName($db,$modelName);
    }
}